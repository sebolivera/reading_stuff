...
from .models import Post, User, Comment, Book, Chapter
...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'email', 'pen_name')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'email', 'password', 'pen_name', 'is_active', 'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'pen_name', 'is_admin')
